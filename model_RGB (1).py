...
# Global Parameters
#=====================================================================================
video_path = '/home/ayesha199718/YOuTubeclips'

video_train_feat_path = './features/train_features'
video_test_feat_path = './features/test_features'
...
def get_video_train_data(video_data_path, video_feat_path):
    ...
    video_data['video_path'] = video_data.apply(lambda row: row['VideoID']+'_'+str(int(row['Start']))+'_'+str(int(row['End']))+'.npy', axis=1)
